...
logger = logging.getLogger("cyberguard.config")

DEFAULTS = {
    "general": {"data_dir": "/opt/cyberguard/data", "log_dir": "/var/log/cyberguard", "log_level": "INFO"},
    ...
    "email": {
        ...
        "from_address": "sentinel@cyberguard.local",
    ...
    "netgate": {
        ...
        "verify_ssl": False, "block_alias": "CyberGuard_Block", "timeout": 15,
    ...
    "web": {"enabled": True, "host": "0.0.0.0", "port": 8443,
            "secret": "CHANGEZ-MOI", "username": "admin", "password_hash": ""},
    "retention": {"alerts_days": 90, "events_days": 30, "flows_days": 14},
}

class Config:
    def __init__(self, path=None):
        self.path = Path(path) if path else Path("/opt/cyberguard/config.yaml")
        self._d = {}
        self._load()
