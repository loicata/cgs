"""
CyberGuard Sentinel — Country-specific legal data.
...
COUNTRIES = {
    ...
    "IE": {
        ...
        "pdf_declaration": (
            ...
            "système CyberGuard Sentinel et n'ont pas été modifiées. "
    ...
    "US": {
        ...
        "pdf_declaration": (
            ...
            "The technical data was automatically collected by the CyberGuard "
