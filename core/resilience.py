"""
CyberGuard Sentinel — Resilience & self-protection module.
...
logger = logging.getLogger("cyberguard.resilience")
...
class SelfMonitor:
    ...
    def _get_disk(self) -> float:
        try:
            st = os.statvfs("/var/log/cyberguard")
...
class SafeBackup:
    ...
    def _safe_sqlite_copy(self):
        ...
        src_path = os.path.join(
            self.cfg.get("general.data_dir", "/var/lib/cyberguard/data"),
            "cyberguard.db"
        )
